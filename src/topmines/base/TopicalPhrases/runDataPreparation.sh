...
java -Xmx400g -cp $classpath  $className $inputFile $datasetName $minsup $startsWithID $stopwordFile


#second run parepare partition
echo ___
className="DataPreparation/PreparePartitionFile"
java -Xmx400g -cp $classpath  $className $inputFile $datasetName $startsWithID
echo ___
